        ...
        <div class="d-flex row-gap mb-3">
            <div style="flex:1">
                ...
                <select id="type" name="type" class="form-select" required>
					...
					<option value="INCOME" <%= (txn.getType() != null && txn.getType().toString().equals("INCOME")) ? "selected" : "" %>>Income</option>
					<option value="EXPENSE" <%= (txn.getType() != null && txn.getType().toString().equals("EXPENSE")) ? "selected" : "" %>>Expense</option>
                </select>
            </div>
