<%@include file="head.jsp" %>
	...
	<%
		...
		java.util.List<com.ksa.pfm.model.Transaction> txns = (java.util.List<com.ksa.pfm.model.Transaction>) request.getAttribute("txns");
 %>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<button type="submit" name="txn" class="btn-delete" value="<%= txn.getId() %>" }>Delete</button>
									</form>
								</td>
							</tr>
							<% } } else { %>
